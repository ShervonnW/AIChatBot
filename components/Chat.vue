...
//import { type ThreadMessage } from 'openai/resources/beta/threads/messages.ts';
...
/*async function fetchPreviousChat() {
  ...
  const response = await fetch('/api/previous-chat-messages');
  const messages = await response.json();
  
  // Add the previous messages to the start of your messages array
